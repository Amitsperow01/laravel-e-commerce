                ...
                <div class="col-xl-3 col-lg-3 col-sm-12 col-xs-12 sidebar-shop-left">
                    <div class="product-categori">
                        ...
                        <div class="filter-price-left">
                            <div class="title-left">
                                <h3>Price</h3>shop-box-inner
                            </div>
                            <div class="price-box-slider">
                                <div id="slider-range"
                                    class="ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all">
                                    <div class="ui-slider-range ui-widget-header ui-corner-all"
                                        style="left: 25%; width: 36.475%;"></div><span
                                        class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0"
                                        style="left: 25%;"></span><span
                                        class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0"
                                        style="left: 61.475%;"></span>
                                </div>
                                <p>
                        ...
                        <div class="row product-categorie-box">
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade show active" id="grid-view">
                                    <div class="row">
                                        @foreach ($categories->product as $subcategory)
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                <div class="products-single fix">
                                                    <div class="box-img-hover">
                                                        ...
                                                        <img src="{{ $subcategory->getFirstMediaUrl('banner_image') }}"
                                                            class="img-fluid" alt="Image" style="height:400px">
                                                        <div class="mask-icon">
                                                            <ul>
                                                                ...
                                                                <li><a href="#" data-toggle="tooltip"
                                                                        data-placement="right" title="Compare"><i
                                                                            ...
                                                                            <li><form action="{{ route('wishlist.store') }}" method="post">
                                                                                ...
                                                                                <input type="hidden" name="product_id" value="{{ $subcategory->id }}">
                                                    ...
                                                    <div class="why-text">
                                                        <h1> <a
                                                                href="{{ route('product.data', $subcategory->url_key) }}">{{ $subcategory->name }}</a>
                                                        </h1>
                                                    ...
                                                    @foreach ($categories->product as $subcategory)
                                                        ...
                                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                            <div class="products-single fix">
                                                                <div class="box-img-hover">
                                                                    ...
                                                                    <img src="{{ $subcategory->getFirstMediaUrl('thumbnail_image') }}"
                                                        ...
                                                        <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                            <div class="why-text full-width">
                                                                <h4>{!! $subcategory->short_description !!}</h4>
                                                                <h5> <del>{!! $subcategory->price !!}</del>{!! $subcategory->special_price !!}
                                                                </h5>
