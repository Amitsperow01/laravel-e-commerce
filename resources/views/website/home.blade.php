...
@section('content')
    <div id="slides-shop" class="cover-slides">
        <ul class="slides-container">
            @foreach ($sliders as $slider)
                <li class="text-left">
                    <img src="{{ $slider->getFirstMediaUrl('image') }}" alt="" style="height:4000px">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
    ...
    <div class="categories-shop">
        <div class="container">
            ...
            <div class="row">
                @foreach (frontategories() as $category)
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="shop-cat-box">
                            <img class="img-fluid" src="{{ $category->getFirstMediaUrl('thumbnail_image') }}" alt="" style="height:400px">
                            <a class="btn hvr-hover"
                                href="{{ route('category.data', $category->url_key) }}">{{ $category->name }}</a>
                        </div>
                    </div>
                @endforeach
            </div>
    ...
    <div class="products-box">
        <div class="container">
            ...
            <div class="row special-list">
                @foreach (frontproduct() as $_featured)
                    <div class="col-lg-3 col-md-6 special-grid best-seller">
                        <div class="products-single fix">
                            <div class="box-img-hover">
                                ...
                                <img src="{{ $_featured->getFirstMediaUrl('thumbnail_image') }}" class="img-fluid"
                            ...
                            <div class="why-text">
                                <h4>{!! $_featured->description !!}</h4>
                                <h5> {{ $_featured->price }}</h5>
                            </div>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="row">
                @foreach ($blocks as $block)
                    <div class="col-md-6 col-lg-4 col-xl-4">
                        <div class="blog-box">
                            <div class="blog-img">
                                <img class="img-fluid" src="{{ $block->getFirstMediaUrl('image') }}" alt="" style="height:400px"/>
                            </div>
