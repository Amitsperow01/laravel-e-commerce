...
@section('content')
    ...
    <div class="cart-box-main">
        <div class="container">
                ...
                <div class="row new-account-login">
                    <div class="col-sm-6 col-lg-6 mb-3">
                        ...
                        <form action="{{ route('customer.authenticate') }}" method="POST"
                            class="mt-3 collapse review-form-box" id="formLogin">
                            @csrf
                            <div class="form-row">
                    ...
                    <div class="col-sm-6 col-lg-6 mb-3">
                        ...
                        <h5><a data-toggle="collapse" href="#formRegister" role="button" aria-expanded="false">Click here
                                to Register</a></h5>
                        <form action="{{ route('customer.store') }}" method="POST" class="mt-3 collapse review-form-box"
                            id="formRegister">
                            @csrf
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="password"
                                        value="{{ old('password') }}" id="InputPassword1" placeholder="Password">
                                </div>
                                @error('password')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
            ...
            @endif
            <form class="needs-validation" id="checkout-address" action="{{ route('cart.checkout.store') }}"
                method="POST">
                @csrf
                <div class="row">
                    <div class="col-sm-6 col-lg-6 mb-3">
                        ...
                        <div class="second-billing-address" id="shipping-address" style="display: none">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="shipping_address_1"
                                    placeholder="Address" value="{{ old('shipping_address_1') }}">
                        ...
                        <div class="row">
                                            ...
                                            @foreach ($cartdata->quoteItems as $quote)
                                                ...
                                                <div class="media-body"> <a href=""> Lorem ipsum dolor sit amet</a>
                                                    <div class="small text-muted">
                                                        ...
                                                        <span class="mx-2">|</span> Subtotal:₹{{ $cartdata->subtotal }}
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="order-box">
                                    ...
                                    <div class="d-flex">
                                        <h4>Sub Total</h4>
                                        <div class="ml-auto font-weight-bold">₹{{ $cartdata->subtotal }} </div>
                                    </div>
                                    ...
                                    <div class="gr-total">
                                        ...
                                        <h3 class="cart-total" style="float: right;">₹{{ $cartdata->total }}</h3>
                                    </div>
                                    <hr>
                                </div>
                            </div>
