<nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                ...
                @foreach (getCategories() as $category)
                    @if (SubCategories($category->id)->count())
                        <li class="nav-item dropdown">
                            {{-- <a class="nav-link  getSubcategorys($category->id)->count() ? 'dropdown-toggle arrow' : '' }}" --}}
                            ...
                            <ul class="dropdown-menu">
                                @foreach (SubCategories($category->id) as $subcategory)
                                    <li><a href="{{ route('category.data', $subcategory->url_key) }}"
                    ...
                    @else
                        <li>
                            <a href="{{ route('category.data', $category->url_key) }}"
        ...
        <div class="attr-nav">
            <ul>
                {{-- <li class="search"><a href="{{ route('cart') }}"><i class="fa fa-search"></i></a></li> --}}
